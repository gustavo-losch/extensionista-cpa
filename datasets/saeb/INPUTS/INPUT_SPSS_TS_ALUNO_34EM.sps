...
VARIABLE LABELS TX_RESP_Q01 'Qual é o seu sexo?'.
 ...
 'A' 'Masculino.'
 'B' 'Feminino.'.
 VARIABLE LABELS TX_RESP_Q02 'Qual é a sua idade?(Questionário de aluno do Ensino Médio)'.
 ...
 'C' 'Entre 1 e 2 horas.'
 'D' 'Mais de 2 horas.'.
 VARIABLE LABELS TX_RESP_Q21 'Quando terminar o Ensino Médio você pretende:(Questionário de aluno do Ensino Médio)'.
 ...
 'D' 'Ainda não sei.'.
 VARIABLE LABELS TX_RESP_Q22 'Você concluiu o Ensino Fundamental na Educação de Jovens e Adultos (EJA), antigo supletivo?'.
 VALUE LABELS TX_RESP_Q22
 '*' 'Nulo'
 '.' 'Branco'
 'A' 'Não.'
 'B' 'Sim.'.
 VARIABLE LABELS TX_RESP_Q23a 'Durante a pandemia, indique a frequência com que os seguintes fatos ocorreram: - Eu possuía equipamento adequado para acompanhar o ensino remoto.'.
 ...
 'C' 'Várias vezes'
 'D' 'Sempre.'.
 VARIABLE LABELS TX_RESP_Q23b 'Durante a pandemia, indique a frequência com que os seguintes fatos ocorreram: - Eu tive conexão de internet adequada para acesso às aulas remotas.'.
 ...
 'C' 'Várias vezes'
 'D' 'Sempre.'.
 VARIABLE LABELS TX_RESP_Q23c 'Durante a pandemia, indique a frequência com que os seguintes fatos ocorreram: - Tive facilidade em usar os programas de comunicação nas aulas remotas.'.
 ...
 'C' 'Várias vezes'
 'D' 'Sempre.'.
 VARIABLE LABELS TX_RESP_Q23d 'Durante a pandemia, indique a frequência com que os seguintes fatos ocorreram: - Recebi material impresso da escola (livros, apostilas, atividades em folha etc.).'.
 ...
 'C' 'Várias vezes'
 'D' 'Sempre.'.
 VARIABLE LABELS TX_RESP_Q23e 'Durante a pandemia, indique a frequência com que os seguintes fatos ocorreram: - Os professores me auxiliaram a entender o conteúdo.'.
 ...
 'C' 'Várias vezes'
 'D' 'Sempre.'.
 VARIABLE LABELS TX_RESP_Q23f 'Durante a pandemia, indique a frequência com que os seguintes fatos ocorreram: - Eu compreendi o conteúdo das aulas remotas.'.
 ...
 'C' 'Várias vezes'
 'D' 'Sempre.'.
 VARIABLE LABELS TX_RESP_Q23g 'Durante a pandemia, indique a frequência com que os seguintes fatos ocorreram: - Em casa havia um lugar tranquilo para eu assistir às aulas.'.
 ...
 'C' 'Várias vezes'
 'D' 'Sempre.'.
 VARIABLE LABELS TX_RESP_Q23h 'Durante a pandemia, indique a frequência com que os seguintes fatos ocorreram: - Meus familiares apoiaram o meu estudo.'.
 ...
 'C' 'Várias vezes'
 'D' 'Sempre.'.
 VARIABLE LABELS TX_RESP_Q23i 'Durante a pandemia, indique a frequência com que os seguintes fatos ocorreram: - Meus colegas me apoiaram durante o ensino remoto.'.

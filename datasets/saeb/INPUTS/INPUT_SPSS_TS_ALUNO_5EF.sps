...
GET DATA
  ...
  ID_BLOCO_1_MT F1.0
  ID_BLOCO_2_MT F1.0
  TX_RESP_BLOCO1_LP A11
  TX_RESP_BLOCO2_LP A11
  TX_RESP_BLOCO1_MT A11
  TX_RESP_BLOCO2_MT A11
...
VARIABLE LABELS TX_RESP_Q01 'Qual é o seu sexo?'.
 ...
 VARIABLE LABELS TX_RESP_Q02 'Qual é a sua idade?(Questionário de aluno do 5º ano)'.
 ...
 'C' 'Entre 1 e 2 horas.'
 'D' 'Mais de 2 horas.'.
 VARIABLE LABELS TX_RESP_Q21a 'Durante a pandemia, indique a frequência com que os seguintes fatos ocorreram: - Eu possuía equipamento adequado para acompanhar o ensino remoto.'.
 VALUE LABELS TX_RESP_Q21a
 '*' 'Nulo'
 '.' 'Branco'
 'A' 'Nunca ou quase nunca.'
 'B' 'De vez em quando.'
 'C' 'Várias vezes'
 'D' 'Sempre.'.
 VARIABLE LABELS TX_RESP_Q21b 'Durante a pandemia, indique a frequência com que os seguintes fatos ocorreram: - Eu tive conexão de internet adequada para acesso às aulas remotas.'.
 VALUE LABELS TX_RESP_Q21b
 '*' 'Nulo'
 '.' 'Branco'
 'A' 'Nunca ou quase nunca.'
 'B' 'De vez em quando.'
 'C' 'Várias vezes'
 'D' 'Sempre.'.
 VARIABLE LABELS TX_RESP_Q21c 'Durante a pandemia, indique a frequência com que os seguintes fatos ocorreram: - Tive facilidade em usar os programas de comunicação nas aulas remotas.'.
 VALUE LABELS TX_RESP_Q21c
 '*' 'Nulo'
 '.' 'Branco'
 'A' 'Nunca ou quase nunca.'
 'B' 'De vez em quando.'
 'C' 'Várias vezes'
 'D' 'Sempre.'.
 VARIABLE LABELS TX_RESP_Q21d 'Durante a pandemia, indique a frequência com que os seguintes fatos ocorreram: - Recebi material impresso da escola (livros, apostilas, atividades em folha etc.).'.
 VALUE LABELS TX_RESP_Q21d
 '*' 'Nulo'
 '.' 'Branco'
 'A' 'Nunca ou quase nunca.'
 'B' 'De vez em quando.'
 'C' 'Várias vezes'
 'D' 'Sempre.'.
 VARIABLE LABELS TX_RESP_Q21e 'Durante a pandemia, indique a frequência com que os seguintes fatos ocorreram: - Os professores me auxiliaram a entender o conteúdo.'.
 VALUE LABELS TX_RESP_Q21e
 '*' 'Nulo'
 '.' 'Branco'
 'A' 'Nunca ou quase nunca.'
 'B' 'De vez em quando.'
 'C' 'Várias vezes'
 'D' 'Sempre.'.
 VARIABLE LABELS TX_RESP_Q21f 'Durante a pandemia, indique a frequência com que os seguintes fatos ocorreram: - Eu compreendi o conteúdo das aulas remotas.'.
 VALUE LABELS TX_RESP_Q21f
 '*' 'Nulo'
 '.' 'Branco'
 'A' 'Nunca ou quase nunca.'
 'B' 'De vez em quando.'
 'C' 'Várias vezes'
 'D' 'Sempre.'.
 VARIABLE LABELS TX_RESP_Q21g 'Durante a pandemia, indique a frequência com que os seguintes fatos ocorreram: - Em casa havia um lugar tranquilo para eu assistir às aulas.'.
 VALUE LABELS TX_RESP_Q21g
 '*' 'Nulo'
 '.' 'Branco'
 'A' 'Nunca ou quase nunca.'
 'B' 'De vez em quando.'
 'C' 'Várias vezes'
 'D' 'Sempre.'.
 VARIABLE LABELS TX_RESP_Q21h 'Durante a pandemia, indique a frequência com que os seguintes fatos ocorreram: - Meus familiares apoiaram o meu estudo.'.
 VALUE LABELS TX_RESP_Q21h
 '*' 'Nulo'
 '.' 'Branco'
 'A' 'Nunca ou quase nunca.'
 'B' 'De vez em quando.'
 'C' 'Várias vezes'
 'D' 'Sempre.'.
 VARIABLE LABELS TX_RESP_Q21i 'Durante a pandemia, indique a frequência com que os seguintes fatos ocorreram: - Meus colegas me apoiaram durante o ensino remoto.'.
 VALUE LABELS TX_RESP_Q21i
 '*' 'Nulo'
 '.' 'Branco'
 'A' 'Nunca ou quase nunca.'
 'B' 'De vez em quando.'
